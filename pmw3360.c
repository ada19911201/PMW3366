...
#endif
#define INIT_CPI 0x18  // limits to 0--119, should be max cpi/100
...
void pmw3360_upload_firmware(void) 
{
	...
	PMW3360_CS_HIGH;
	delay_us(10); // arbitrary padding

	PMW3360_CS_LOW;
    delay_us(10);
	spi_write_adv(0x0f, INIT_CPI);
...
report_pmw3360_t pmw3360_read_burst(void) {
    static report_pmw3360_t data = {0};
    PMW3360_CS_LOW;
    if (!_inBurst) {
